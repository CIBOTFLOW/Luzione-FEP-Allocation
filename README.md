...
The G0-only adapters in `src/a02B03AllocationAdapter.js`, `src/b03PostCommitEvidenceAdapter.js`, and `src/b03DurableFundingAdapter.js` pin controller release `b43e5a65c0ae8c8bcef7e015e4a3484877f736b0`, `CIBOTFLOW/Luzione-API@12685f46a60edea23aaa0a5403e300bf8858066b` with final evidence `bc43d5db8fe58230d6c3d35e32a73e1e8618b71e`, exactly all five `v0.2-draft.1` identifiers, and corrected B03 producer `CIBOTFLOW/FEP-Platform@5db6cc8772c40a7127b7514c57787299ddad57a5` with `fep-balanced-journal/v0.1-draft`.
